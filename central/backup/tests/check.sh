...
docker-compose exec first_etcd etcdctl get / --prefix --user=root --password=password
docker-compose exec second_etcd etcdctl get / --prefix --user=root --password=second_password
