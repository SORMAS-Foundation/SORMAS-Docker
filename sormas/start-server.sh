...
${ASADMIN} --user admin --passwordfile /root/oldpwfile.txt change-admin-password --domaindir ${DOMAINS_HOME} --domain_name ${DOMAIN_NAME}
${ASADMIN} --user admin --passwordfile /root/newpwfile.txt enable-secure-admin
