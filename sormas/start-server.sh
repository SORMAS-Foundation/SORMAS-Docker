...
${ASADMIN} create-javamail-resource --mailhost ${MAIL_HOST} --mailuser "sormas" --fromaddress ${MAIL_FROM} --auth false --enabled true --property  "mail.smtp.port=${SMTP_PORT}:mail.smtp.auth=false:mail.smtp.starttls.enable=false" mail/MailSession
