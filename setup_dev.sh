...
sudo docker-compose -f /home/deploy/SORMAS-Docker/docker-compose-build.yml build --no-cache keycloak sormas postgres keycloak-postgres pg_dump apache2 ldbs
